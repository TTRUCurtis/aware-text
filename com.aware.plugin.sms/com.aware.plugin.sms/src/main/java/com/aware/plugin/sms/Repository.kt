...
class Repository @Inject constructor(
                ...
                try {
                    if (mmsCursor.moveToFirst()) {
                        ...
                        do {
                            ...
                            val mmsDate =
                                mmsCursor.getString(mmsCursor.getColumnIndexOrThrow(MsgConstants.KEY_DATE)) //date is given by a fraction of 1000, hence following line
                            date = mmsDate.toLong() * 1000
                            type =
                                mmsCursor.getString(mmsCursor.getColumnIndexOrThrow(MmsConstants.KEY_M_TYPE))
                            ...
                            if (mmsAddrCursor != null && mmsAddrCursor.moveToFirst()) {
                                ...
                                do {
                                    ...
                                    val address =
                                        if (rawAddress != "insert-address-token") rawAddress else ""
    ...
    //What does this mean
    //TODO move to settings or do we need it
    ...
    fun pullSmsOnly() =
        Aware.getSetting(applicationContext, Settings.PLUGIN_SMS_CONTINUE_WITH_SMS_ONLY)
            .isNotEmpty() &&
                Aware.getSetting(
                    applicationContext,
    ...
    fun pullMmsOnly() =
        Aware.getSetting(applicationContext, Settings.PLUGIN_SMS_CONTINUE_WITH_MMS_ONLY)
            .isNotEmpty() &&
                Aware.getSetting(
                    applicationContext,
